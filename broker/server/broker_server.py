...
def remote_client_thread(send_socket, queue):
    """
    ...
    while True:
        ...
        if queue.empty():
            ...
            print 'Data received inside thread', data
            try:
...
queue = Queue()
send_socket.connect((cfg.SEND_HOST, cfg.SEND_PORT))
...
while True:
    ...
    if data:
        ...
        start_new_thread(remote_client_thread, (send_socket, queue, )) #start new client thread
